from .views import RegistrationView, UsernameValidationView, EmailValidationView, RequestPasswordResetEmail, \
    VerificationView, LoginView,\
    LogoutView, CompletePasswordReset
